...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        variant: "default",
        className: cn("top-4 left-1/2 transform -translate-x-1/2 fixed md:top-4 md:right-4 md:left-auto md:transform-none"),
      });
      setLoading(false);
      setFullName("");
      setEmail("");
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          ...
          onChange={(e) => {
            ...
            if (messageError && e.target.value.length >= 10) {
              setMessageError("");
            }
          }}
        />
      ...
      <Button
        disabled={loading}
        className="bg-primary hover:bg-primary/90 relative group/btn w-full text-primary-foreground rounded-md h-10 font-medium"
        type="submit"
      >
        {loading ? (
