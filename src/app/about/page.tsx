...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "nethroughwickramasinghe@yahoo.com",
    href: "mailto:nethroughwickramasinghe@yahoo.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/n-wickramasinghe-1395a0264",
    content: "/n-wickramasinghe-1395a0264",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/nethrough",
    content: "/nethrough",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Nethrough Wickramasinghe</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Nethrough Wickramasinghe, a passionate Full Stack Developer who loves creating
              innovative web applications that solve real-world problems. I specialize in React, Firebase, 
              Python, and machine learning technologies. My projects range from peer-to-peer marketplaces 
              to AI-powered applications, always focusing on connecting people and creating meaningful impact.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring new technologies, working on personal projects,
              or thinking about how to make the next big thing that will help people connect and thrive.
            </p>
